...
contract CryptoDevs is ERC721Enumerable, Ownable {
    /**
      ...
      token will be concatenation of the `baseURI` and the `tokenId`. 
      */
    ...
    name in our case in `Crypto Devs` and symbol is `CD`.
    ...
    */
    ...
    // Function to receive Ether. msg.data must me empty
